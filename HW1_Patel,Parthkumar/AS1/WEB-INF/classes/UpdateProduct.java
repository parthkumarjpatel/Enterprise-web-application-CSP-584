...
public class UpdateProduct extends HttpServlet {
	...
	private String getProductView(Product p) {
		return "<div class='row'>"
				...
				+ "<form class='form-signin' method='post' action='/AS1/UpdateProduct?UpdateProduct=true' >"
				...
				+ ""
				 ...
				 + "<a class='btn btn-lg btn-outline-dark' role='button' href='/AS1/UpdateProduct?DeleteProduct="+p.getProductId()+"' >Delete Product</a>"
				 + "</form>"
				 + "</div>"
				+ "</div>"
				+ "<div class='col-md-3'></div>"
	...
	private String getHTMLContent() {
		return "<div id='body'>"
				...
				+ "<div class='col-md-6'>"
				+ "<div class='container text-center'>"
				+ "<form class='form-signin' method='post' action='/AS1/UpdateProduct?findProduct=true'>"
