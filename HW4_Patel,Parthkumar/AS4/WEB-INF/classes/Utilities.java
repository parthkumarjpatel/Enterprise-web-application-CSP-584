...
public class Utilities extends HttpServlet {
	...
	public String printHtmlUserLeftNav(String file, User currentUser) {
		...
		if(currentUser.getRole()==0) {
			replaceBy = ""
					...
					+ "<h4>User Control</h4>"
					+ "<ul>"
					+ "<li><a href='/AS4/ViewOrderServlet\'>View Order</a></li>"
					+ "</ul>"
					+ "</li>";
			...
			replaceBy = ""
					...
					+ "<h4>User Control</h4>"
					+ "<ul>"
					+ "<li><a href='/AS4/AddProduct'>Add Product</a></li>"
					+ "<li><a href='/AS4/UpdateProduct'>Update/Delete Product</a></li>"
					+ "<li><a href='/AS4/InventoryServlet'>Inventory Report</a></li>"
					+ "<li><a href='/AS4/SalesServlet'>Sales Report</a></li>"
					+ "</ul>"
					+ "</li>";
			...
			replaceBy = ""
					...
					+ "<h4>User Control</h4>"
					+ "<ul>"
					+ "<li><a href='/AS4/Registration\'>Register Customer</a></li>"
					+ "<li><a href='/AS4/UpdateOrder\'>View Order</a></li>"
					// + "<li><a href='/AS4/LogoutServlet'>Logout</a></li>"
					+ "</ul>"
					+ "</li>";
		...
		if(currentUser.getRole()==1) {
			replaceBy2=""
					...
					+"<ul>"
					+"<li><a href='/AS4/DataAnalyticsServlet\'>Data Analytics on Review</a></li>"
					+"</ul>"
					+"</li>";
		}
	...
	public String printHtmlUserHeader(String file, User currentUser) {
		...
		lookupString = "/AS4/LoginServlet";
		replaceBy = "/AS4/LogoutServlet";
		result = HTMLStringReplace(result, lookupString, replaceBy);
