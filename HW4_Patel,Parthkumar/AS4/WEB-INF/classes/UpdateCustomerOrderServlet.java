...
private String getOrderView(Order ord) {
		...
		String _Header = "<div class='row'>"
				...
				+ "<a class='btn btn-danger pull-right' role='button'  href='/AS4/CancelOrderServlet?cancelOrder="+ord.getOrderId()+"'    >Cancel Order</a>"
				+ "</div>"
				+"<div class='row'>"
				+ "<div class='col-sm-3'>"
		...
		for (Map.Entry<Product, Integer> entry : cart.entrySet()) {
			...
			total +=subtotal;
				...
				_Content +=""
						+ "<form action='/AS4/UpdateCustomerOrderServlet?update=true' method='post'>"
						+ "<tr>"
	...
	private String getHTMLContent() {
		return "<div id='body'>"
				...
				+ "<div class='col-md-6'>"
				+ "<div class='container'>"
				+ "<form class='form-signin' method='post' action='/AS4/UpdateCustomerOrderServlet?order=display'>"
