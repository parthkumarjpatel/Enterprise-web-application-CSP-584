  ...
  private String content_footer(){
	...
	private String printCart() {
		String _Header = "<div id='body'>"
				+ "<section id='content'>"
				+ (userLoggedIn ? "<form action='/AS4/PlaceOrderServlet' method='post'>":"<form action='/AS4/LoginServlet' method='post'>")
				+ "<div class='box'>"
		...
		for (Map.Entry<Product, Integer> entry : cart.entrySet()) {
			...
			_Content +="<tr>"
					...
					+ "<td><a href='/AS4/RemoveFromCart?requestedForm=RemoveFromCart&&cartProduct="+p.getProductId()+"' class='btn btn-outline-dark' role='button'>Remove</a></td>";
			count++;
