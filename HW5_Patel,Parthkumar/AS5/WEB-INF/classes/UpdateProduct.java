...
//				Product  p =  SaxParserReader.findProductById(Integer.parseInt(productId));
	...
	private String getProductView(Product p) {
		return "<div class='row'>"
				...
				+ "<form class='form-signin' method='post' action='/AS5/UpdateProduct?UpdateProduct=true' >"
				...
				+ ""
				 ...
				 + "<a class='btn btn-lg btn-outline-dark' role='button' href='/AS5/UpdateProduct?DeleteProduct="+p.getProductId()+"' >Delete Product</a>"
				 + "</form>"
				 + "</div>"
				+ "</div>"
				+ "<div class='col-md-3'></div>"
	...
	private String getHTMLContent() {
		return "<div id='body'>"
				...
				+ "<div class='col-md-6'>"
				+ "<div class='container text-center'>"
				+ "<form class='form-signin' method='post' action='/AS5/UpdateProduct?findProduct=true'>"
