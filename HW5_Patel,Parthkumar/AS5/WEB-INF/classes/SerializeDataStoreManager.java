...
public class SerializeDataStoreManager {
	...
	private static final String USER$INFO = "C:/apache-tomcat-7.0.34/webapps/AS5"+"/webdata/person.txt";
	private static final String ORDER$INFO = "C:/apache-tomcat-7.0.34/webapps/AS5"+"/webdata/order.txt";
