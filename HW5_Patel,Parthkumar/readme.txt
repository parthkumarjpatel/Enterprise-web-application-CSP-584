...
•To setup the project in your local machine, first of all you need to put the folder named AS5 under your webapps folder.
•After putting folder in the webapps you need to open cmd there and go to AS5/WEB-INF/classes using cmd command and after reaching there you can run below command to compile all java files.

•Javac *.java

•After Compiling it start tomcat server then you can run the project in your machine. 
You need to open browser and type URL like localhost:8080/AS5/home which redirects you to Home page of application.
