...
•You need to refer Mysql.sql file which is attached. First create database named bestdeal. Then run this sql files which has a syntax of creating tables and inserting information of products and its accessories. It will create tables and enter products and its accessories information into tables.
--------------------------
•MongoDb Server : 
...
•To setup the project in your local machine, first of all you need to put the folder named AS2 under your webapps folder.
•After putting folder in the webapps you need to open cmd there and go to AS2/WEB-INF/classes using cmd command and after reaching there you can run below command to compile all java files.
